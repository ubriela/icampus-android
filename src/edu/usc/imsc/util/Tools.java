...
public class Tools {
	...
	public static String TEST_SERVER_PORT = "128.125.163.126:8080";
	public static String LOCAL_SERVER_PORT = "10.0.2.2:8084";
	...
	// Image upload
	public static final String UPLOAD_IMAGE_URL = "http://" + TEST_SERVER_PORT
			+ "/CSCI587SERVER/UploadImageAction.do?method=UploadPhoto";

	// Explore food
	public static final String TOP_FOOD_SPATIAL_QUERY_SERVICE = "http://"
			+ TEST_SERVER_PORT + "/CSCI587SERVER/TopQueryFoodAction.do?";
	public static final String NEARBY_FOOD_SPATIAL_QUERY_SERVICE = "http://"
			+ TEST_SERVER_PORT + "/CSCI587SERVER/NearbyQueryFoodAction.do?";
	public static final String RECENT_FOOD_SPATIAL_QUERY_SERVICE = "http://"
			+ TEST_SERVER_PORT + "/CSCI587SERVER/RecentQueryFoodAction.do?";

	// Trajectory save location
	public static final String USER_STATISTIC_URL = "http://" + TEST_SERVER_PORT
			+ "/CSCI587SERVER/SaveLocationAction.do?";
	public static final String USER_STATISTIC_URL2 = "http://" + TEST_SERVER_PORT
	...
	public static final String BUILDING_LINE_QUERY_SERVICE = "http://"
			+ TEST_SERVER_PORT + "/CSCI587SERVER/BuildingLineStringQueryAction.do?";

	// Query demo
	public static final String RECTANGLE_SPATIAL_QUERY_SERVICE = "http://"
			+ TEST_SERVER_PORT + "/CSCI587SERVER/RectangleQueryFoodAction.do?";
	public static final String CIRCLE_SPATIAL_QUERY_SERVICE = "http://"
			+ TEST_SERVER_PORT + "/CSCI587SERVER/WithinDistanceQueryFoodAction.do?";
	public static final String POLYGON_SPATIAL_QUERY_SERVICE = "http://"
			+ TEST_SERVER_PORT + "/CSCI587SERVER/PolygonQueryFoodAction.do?";
	public static final String KNN_SPATIAL_QUERY_SERVICE = "http://"
			+ TEST_SERVER_PORT + "/CSCI587SERVER/KNNQueryFoodAction.do?";
	...
	public static String getUserProfileUrlSet(String fname, String lname,
		...
		return USER_PROFILE_URL + "?fname=" + fname.replace(" ", "%20")
				+ "&lname=" + lname.replace(" ", "%20") + "&email=" + email
				+ "&fb_id=" + fb_id;
	}
	...
	// public static final int TRAJECTORY_POINTS_NUMBER = 15;
	// public static final int TRAJECTORY_DISTANCE_BETWEEN_POINTS = 500;
	// public static final int TRAJECTORY_DISTANCE_TO_LINES = 5000;
	public static final int TRAJECTORY_POINTS_SEARCH = 1; // 0 means search all
	...
	public static final int PHOTO_REQUIRED_SIZE = 1024;
	public static final int SMALLPHOTO_REQUIRED_SIZE = 512;
	public static final int ICONPHOTO_REQUIRED_SIZE = 128;
	...
	public static String getTopFoodsURL(GeoPoint gPoint, int start, int num) {
		// TODO Auto-generated method stub
		return TOP_FOOD_SPATIAL_QUERY_SERVICE 
	...
	public static String getNearbyFoodsURL(GeoPoint gPoint, int start, int num) {
		// TODO Auto-generated method stub
		return NEARBY_FOOD_SPATIAL_QUERY_SERVICE 
				+ "lat=" + gPoint.getLatitudeE6() / 1E6 
				+ "&lon=" + gPoint.getLongitudeE6() / 1E6 
				+ "&start=" + start
				+ "&num=" + num;
	...
	public static String getRecentFoodsURL(GeoPoint gPoint, int start, int num) {
		// TODO Auto-generated method stub
		return RECENT_FOOD_SPATIAL_QUERY_SERVICE 
		+ "lat=" + gPoint.getLatitudeE6() / 1E6 
		+ "&lon=" + gPoint.getLongitudeE6() / 1E6 
		+ "&start=" + start
		+ "&num=" + num;
