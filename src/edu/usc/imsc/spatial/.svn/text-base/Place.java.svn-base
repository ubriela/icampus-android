 ...
 * @author linghu
 */
public class Place extends AbstractPointPlace implements Comparable<Place> {
	 ...
	 */
	private Place(int id, String name, String shortName) {
		this(id);
		this.name = name;
	 ...
	 */
	public Place(int id, String name, String shortName, double latitude,
			double longitude) {
	...
	public Place(int id, String name, String shortName, String address, double latitude,
			double longitude) {
		this(id, name, shortName);
	...
	public Place(int id, String name, double latitude,
			double longitude) {
