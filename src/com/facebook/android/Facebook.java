...
public class Facebook {
    ...
    public void authorize(Activity activity, final DialogListener listener) {
        authorize(activity, new String[] {}, FORCE_DIALOG_AUTH,	//DEFAULT_AUTH_ACTIVITY_CODE
                listener);
    }
    ...
    public void authorize(Activity activity, String[] permissions,
        ...
        authorize(activity, permissions, FORCE_DIALOG_AUTH, listener); // DEFAULT_AUTH_ACTIVITY_CODE
    }
